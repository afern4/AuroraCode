//ARDUINO INSTRUMENTATION LAB
//Project 1 for instrumentation Lab  
...
#define ECHO_PIN 7                  // Stating the pin on Arduino that will be connected to the echo sensor 
...
#define motor1Pin1 2              // Stating the pin on Arduino that will be connected to the right back wheel 
#define motor1Pin2 3              // Stating the pin on Arduino that will be connected to the right front wheel 
#define motor2Pin1 4              // Stating the pin on Arduino that will be connected to the left front wheel 
#define motor2Pin2 5              // Stating the pin on Arduino that will be connected to the left back wheel 
 
 
void setup() { 
  // Initialize motor control pins as outputs 
  pinMode(motor1Pin1, OUTPUT);       // Setting pin for the right back wheel as an output pin 
  pinMode(motor1Pin2, OUTPUT);       // Setting pin for the right front wheel as an output pin 
  pinMode(motor2Pin1, OUTPUT);       // Setting pin for the left front wheel as an output pin 
  pinMode(motor2Pin2, OUTPUT);       // Setting pin for the left back wheel as an output pin 
} 
